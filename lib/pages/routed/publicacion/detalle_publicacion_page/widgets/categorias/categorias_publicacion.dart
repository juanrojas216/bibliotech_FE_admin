...
//     var categoriasPublicacion = ref.watch(publicacionProvider).categorias;
...
//     var categoriaPublicacion = ref.watch(publicacionProvider).categorias[widget.index];
...
//               onSelected: (_) {
//                 ref.read(publicacionProvider.notifier).deleteValor(widget.index, index);
//                 setState(() {});
//               },
//             ),
//           ),
