            ...
            DecoratedBox(
              ...
              child: CupertinoListTile.notched(
                onTap: () {
                  ...
                  showCupertinoDialog(
                    context: context,
                    builder: (_) => ModificarEntidad<String>(
                        entidad: "/prestamos/$id/checkout",
              ...
              child: CupertinoListTile.notched(
                onTap: () {
                  ...
                  showCupertinoDialog(
                    context: context,
                    builder: (_) => ModificarEntidad<String>(
                        entidad:"/prestamos/$id/extravio",
                        nombreProvider: updateEstadoPrestamoProvider,
                        mensajeResult: "EXTRAVÍO REGISTRADO",
                        mensajeError: "ERROR AL REGISTRAR EXTRAVÍO"),
                  );
                },
                leading: const Icon(Icons.check),
                trailing: const Icon(Icons.arrow_forward_ios),
              ...
              child: CupertinoListTile.notched(
                onTap: () {
                  ...
                  showCupertinoDialog(
                    context: context,
                    builder: (_) => ModificarEntidad<String>(
                        entidad:"/prestamos/$id/cancelar",
                        nombreProvider: updateEstadoPrestamoProvider,
                        mensajeResult: "PRESTAMO CANCELADO",
                        mensajeError: "ERROR AL CANCELAR PRÉSTAMO"),
                  );
                },
                leading: const Icon(Icons.check),
                trailing: const Icon(Icons.arrow_forward_ios),
