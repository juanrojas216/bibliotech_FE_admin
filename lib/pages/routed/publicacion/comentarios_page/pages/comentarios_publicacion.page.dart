...
import '../controllers/getAllComentariosPublicacion.controller.dart';

class ComentariosPublicacionIndex extends ConsumerStatefulWidget {
  final int idPublicacion;

  const ComentariosPublicacionIndex({required this.idPublicacion, super.key});
...
class _ComentariosIndexState
    extends ConsumerState<ComentariosPublicacionIndex> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    var search =
        ref.watch(getAllComentariosPublicacionProvider(widget.idPublicacion));
        ...
        child: Container(
          ...
          child: search.when(
                  ...
                  child: const Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 5),
                        Text("Esta publicacion no posee comentarios"),
                      ],
                    ),
                  ),
                ),
            ...
            error: (response, _) => ErrorResultadoWidget(
              response: response,
              provider:
                  getAllComentariosPublicacionProvider(widget.idPublicacion),
